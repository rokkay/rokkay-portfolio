  ...
  <section class="py-6">
    <div class="container">
      <div class="w-full flex flex-wrap">
        <h3 class="font-bold uppercase text-2xl md:text-4xl w-full my-6">
          Trayectoria
        </h3>
        <div class="divide-y-2 divide-gray-400">
          ...
          <Company
            ...
            description="Mis funciones en Outlet salud fueron la de poner a punto los equipos informáticos así como el desarrollo de páginas web en Wordpress y programación para páginas ya existentes en PHP."
          ></Company>
        </div>
      </div>
    </div>
